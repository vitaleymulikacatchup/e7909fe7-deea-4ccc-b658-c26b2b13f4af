...
export const metadata: Metadata = {
  title: "Welcome to the Future - Webild",
  description: "Innovate with cutting-edge technology solutions. Discover more about our services and team.",
  openGraph: {
    title: "Welcome to the Future - Webild",
    description: "Innovate with cutting-edge technology solutions.",
    siteName: "Webild",
    images: [{
      url: "asset://hero-image"
    }],
    type: "website"
  },
  twitter: {
